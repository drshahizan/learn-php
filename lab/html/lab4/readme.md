...
3. The [Lab5output1.png](./download/Lab4output1.png) file contains the complete website that was generated and can be viewed for reference.
4. You can view the entire website generated by referring to the [Lab4output1.png](./download/Lab4output1.png) file.
5. Text content has been prepared and saved in the [contentlab4.txt](./download/contentlab4.txt) file. 
6. Ensure that you only submit files with the `.html` extension.
