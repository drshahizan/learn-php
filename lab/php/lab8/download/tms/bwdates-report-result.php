...
?>
    ...
    <head>
        ...
        <title>Covid-Tms | Dates Report</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <h1 class="h3 mb-2 text-gray-800">Report Screening Test Results by Date: <?php echo $fdate; ?> to <?php echo $tdate; ?> </h1>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Results by Date</h6>
                            </div>
                            <div class="card-body">
