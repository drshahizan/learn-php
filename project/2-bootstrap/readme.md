...
-->
```
2. You must place your file in the submission folder. Within the [`submission`](./submission) folder, create a folder called your `id github`. Name the default file as `index.html`. Suggested folder structure for this project:
