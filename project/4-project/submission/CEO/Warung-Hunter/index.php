...
<head>
    ...
    <link rel="shortcut icon" href="images/FHicon.png" type="" />
                ...
                <nav class="navbar navbar-expand-lg custom_nav-container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="user_option">
                            <?php
                            if (!isset($username)) {
                                echo "<a href='login.php' class='order_online'> Login </a>";
        ...
        <div class="container">
            ...
            <div class="filters-content">
                <div class="row grid">
                    ...
                    <div class="col-sm-6 col-lg-6 all burger">
                        <div class="box">
                            <div>
                                <div class="img-box">
                    ...
                    <div class="col-sm-6 col-lg-6 all pasta">
                        <div class="box">
                            <div>
                                <div class="img-box">
                    ...
                    <div class="col-sm-6 col-lg-6 all fries">
                        <div class="box">
                            <div>
                                <div class="img-box">
