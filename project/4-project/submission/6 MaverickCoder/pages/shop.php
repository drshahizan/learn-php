			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="breadcrumb-text">
						...
						<h1><span class="orange-text">Shop Kueh</span>Raye</h1>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <li data-filter=".strawberry">Cookies</li>
                            <li data-filter=".berry">Cakes</li>
                        </ul>
                    </div>
                </div>
            </div>
			...
			<div class="row product-lists">
				<div class="col-lg-4 col-md-6 text-center strawberry">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.php"><img src="../images/products/product-img-1.jpg" alt=""></a>
						</div>
						<h3>Almond London</h3>
				...
				<div class="col-lg-4 col-md-6 text-center strawberry">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.php"><img src="../images/products/product-img-2.jpg" alt=""></a>
						</div>
				...
				<div class="col-lg-4 col-md-6 text-center strawberry">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.php"><img src="../images/products/product-img-3.jpg" alt=""></a>
						</div>
						<h3>Nutella Pod</h3>
				...
				<div class="col-lg-4 col-md-6 text-center berry">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.php"><img src="../images/products/product-img-4.jpg" alt=""></a>
						</div>
						<h3>Dates & Cinnamon Cake</h3>
				...
				<div class="col-lg-4 col-md-6 text-center berry">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.php"><img src="../images/products/product-img-5.jpg" alt=""></a>
						</div>
						<h3>Pandan Layer Cake</h3>
						<p class="product-price"><span>(Per Kg)</span> RM55 </p>
						<a href="cart.php" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
