	...
	<div class="latest-news mt-150 mb-150">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-news">
						<a href="single-news-2.php"><div class="latest-news-bg news-bg-2"></div></a>
						<div class="news-text-box">
							<h3><a href="single-news-2.php">Discover the Essence of Eid al-Adha with KuehRaye: Delight in Unforgettable Flavors and Celebrate the Joy of the Season</a></h3>
							<p class="blog-meta">
								<span class="author"><i class="fas fa-user"></i> Admin</span>
							...
							<a href="single-news-2.php" class="read-more-btn">read more <i class="fas fa-angle-right"></i></a>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-news">
						...
						<div class="news-text-box">
							<h3><a href="single-news-3.php">Celebrating Ramadan with KuehRaye's Irresistible Kueh Raya: Elevate Your Festive Season with Exquisite Sweet Treats</a></h3>
							<p class="blog-meta">
								<span class="author"><i class="fas fa-user"></i> Admin</span>
								<span class="date"><i class="fas fa-calendar"></i> 27 December, 2019</span>
							</p>
							...
							<a href="single-news-3.php" class="read-more-btn">read more <i class="fas fa-angle-right"></i></a>
						</div>
					</div>
				</div>
