							...
							<ul>
								...
								<li><a href="pages/news.php">News</a>
									<ul class="sub-menu">
										...
										<li><a href="pages/single-news-3.php">News of the Week</a></li>
									</ul>
								</li>
								...
								<li>
									<div class="header-icons">
										<a class="shopping-cart" href="pages/cart.php"><i
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<div class="abt-bg">
						<a href="https://www.youtube.com/watch?v=vpYClahlC88" class="video-play-btn popup-youtube"><i
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-news">
						...
						<div class="news-text-box">
							...
							<a href="pages/single-news.php" class="read-more-btn">read more <i
