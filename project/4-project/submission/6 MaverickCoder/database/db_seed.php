...
function seedUsersTable()
{
    ...
    $sql = "INSERT INTO users (first_name, last_name, username, email, password, profile_pic_id)
            VALUES
            ('Admin', 'KuehRaye', 'admin', 'admin@kuehraye.com', 'admin123', 1),
            ('Jane', 'Smith', 'janesmith', 'jane@google.com', 'password123', 2),
            ('Mike', 'Johnson', 'mikejohnson', 'mike@google.com', 'password123', 3)";
