	...
	<div class="container">
		<ul class="tp-hd-lft wow fadeInLeft animated" data-wow-delay=".5s">
			<li class="hm"><a href="index.php"><i class="fa fa-home"></i></a></li>
				<li class="hm"><a href="admin/index.php">Admin Log Masuk</a></li>
		</ul>
		<ul class="tp-hd-rgt wow fadeInRight animated" data-wow-delay=".5s"> 
			<li class="tol">Tel : 013-4568790</li>				
...
<div class="header">
	<div class="container">
		<div class="logo wow fadeInDown animated" data-wow-delay=".5s">
			<a href="index.php">Sistem <span> Khairat Kematian Surau Al-ansar</span></a>	
		</div>
					...
					<nav class="cl-effect-1">
						<ul class="nav navbar-nav">
							...
							<li><a href="page.php?type=aboutus">Tentang Kami</a></li>
								<li><a href="package-list.php">Pakej Khairat</a></li>
								<!--<li><a href="page.php?type=privacy">Privacy Policy</a></li>
								<li><a href="page.php?type=terms">Terms of Use</a></li>-->
								<li><a href="page.php?type=contact">Hubungi Kami</a></li>
								<?php if($_SESSION['login'])
{?>
